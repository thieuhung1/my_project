...
// Dữ liệu nội dung được tách ra để JSX sạch hơn và dễ bảo trì.
const HIGHLIGHTS = [
...
const ABOUT_IMAGE = 'https://images.unsplash.com/photo-1550547660-d9450f859349?q=80&w=1200&auto=format&fit=crop';
    ...
    <div className="container my-5 animate__animated animate__fadeIn">
      <div className="text-center mb-5">
        <h1 className="fw-bold">
          Giới Thiệu Về <span className="text-gradient-orange">FoodHub</span>
        </h1>
        <p className="lead text-muted m-0">
          Nền tảng giao đồ ăn nhanh chóng, đa dạng món ngon từ khắp nơi.
        </p>
      </div>
      ...
      <div className="row g-4 align-items-center">
        ...
        <div className="col-md-6">
          ...
          <p className="text-muted">
            Đem những món ăn ngon nhất đến tận tay bạn chỉ trong vòng 30 phút, với trải nghiệm mượt mà và an toàn.
          </p>
