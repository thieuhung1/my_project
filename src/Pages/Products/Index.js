        ...
        {products.map(product => (
          <div key={product.id} className="col-xl-3 col-lg-4 col-md-6">
            <div className="card h-100 shadow-sm hover-lift border-0 rounded-3 overflow-hidden">
              <img src={product.image} className="card-img-top" alt={product.name} loading="lazy" style={{height: '220px', objectFit: 'cover'}} />
              <div className="card-body p-4">
                ...
                <div className="d-grid gap-2">
                  <Link to={`/product/${product.id}`} className="btn btn-warning btn-sm">Chi Tiết</Link>
